"""Servicio para Bicentenario (0175).
Plantilla mínima: `consulta` y `respuesta`.
"""
...
class BancoBicentenarioService(BaseBankService):
    def __init__(self, bank_code: str = "0175", config: Dict[str, Any] = None):
